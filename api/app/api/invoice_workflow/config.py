"""
Configuration for invoice workflow.
...
class InvoiceWorkflowConfig(BaseWorkflowConfig):
    """Configuration specific to invoice workflow."""

    # Override base settings
    app_name: str = "Invoice Workflow"
    ...
    def get_step_prompts(self) -> dict[str, str]:
        ...
        return {
            ...
            "name": "Please say the invoice recipient's name or organization.",
            "email": "Please say the invoice recipient's email address.",
            "address": "Please say the billing address including street, city, and postal code.",
    ...
    def get_validation_rules(self) -> dict[str, Any]:
        """Return validation rules for invoice fields."""
        return {
            "email": {
    ...
    def get_gpt_prompts(self) -> dict[str, str]:
        ...
        return {
            "name": """Extract the invoice recipient's name or organization from the transcribed text.
...
Be intelligent about UK address formats.""",
    ...
    def get_error_messages(self) -> dict[str, str]:
        """Return custom error messages for invoice workflow."""
        base_messages = super().get_error_messages()
        base_messages.update(
            {
                "invalid_email": "Please provide a valid email address",
                "invalid_phone": "Please provide a valid phone number",
                "missing_name": "Invoice recipient name is required",
                "missing_address": "Please provide a complete address",
                "xero_error": "Failed to create invoice in Xero. Please try again.",
                "duplicate_invoice": "An invoice with this reference already exists",
            }
        )
...
@lru_cache
def get_invoice_config() -> InvoiceWorkflowConfig:
    """Get cached invoice workflow configuration."""
